import type { QNA } from "@/types/faqs";

// I know know, there are sponsor data that's stored in the custom-img-loader folder. It's not good, I'm going to move it to this data folder in the future
